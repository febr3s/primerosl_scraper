SirTrevor.Locales.en.blocks = $.extend(SirTrevor.Locales.en.blocks, {
  ...
  iframe: {
    ...
    placeholder: "Enter embed code here. It should begin with e.g. '<iframe', and must contain an 'aria-label' tag describing the iframe, e.g. aria-label='All Surviving Titles'"
  },
